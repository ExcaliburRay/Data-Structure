...
public class ObjectNode {
     ...
     * @precondition Node should not be the none type
     * @runtime The runtime of this method is Θ（1)
     **/
     ...
     * @precondition source should be the ObjectNode type and source cannot be none type
     * @runtime The runtime of this method is Θ（N), N is equal to the list length
    ...
    /**
     * Copy a list taken by recursion calls.
     * @param source the head of a linked list that will be copied (which may be
     *               an empty list in where source is null)
     * @return The method has made a copy of the linked list starting at
     * source. The return value is the head reference for the
    ...
    public static ObjectNode listCopy_rec(ObjectNode source) {
        ...
        //use recursion to get the rest nodes
        if (source.link != null) {
            source = source.link;
            //the next node would be the next copyHead
     ...
     * @precondition source should be the ObjectNode type and source cannot be none type
     * @postcondition the return value of of list length should be int and larger than 0
     * @runtime The runtime of this method is Θ（N), N is equal to the list length
     **/
    ...
    /**
     * Compute the number of nodes in a linked list taken by a recursive method.
     * @param head the head reference for a linked list (which may be an empty list
     *             with a null head)
     * @return the number of nodes in the list with the given head
     * @note A wrong answer occurs for lists longer than Int.MAX_VALUE.
    ...
    /**
     * Display the node information in this list
     * @return the information of the list from the head node to the tail node in order
     * @runtime The runtime of this method is Θ（N), N is equal to the list length
     */
     ...
     * @param args the default declaration
     */
    public static void main(String[] args) {
        ...
        // let A be the head of this LinkedList and append the rest into this.
        ObjectNode node = new ObjectNode(data[0], null);
        ObjectNode head = node;
        for (int i = 1; i < data.length; i++) {
            node.addNodeAfter(data[i]);
            node = node.link;
        }
